...
final class PlayerNode: SKNode {
    ...
    private func assemble() {
        ...
        selection.strokeColor = config.palette.teal
        selection.fillColor = config.palette.teal.withAlphaComponent(0.16)
        selection.lineWidth = 2.2
        selection.glowWidth = 6
        selection.position = CGPoint(x: 0, y: -20)
